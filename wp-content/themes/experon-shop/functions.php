...
function experon_thinkup_child_frontscripts() {
	...
	wp_enqueue_style( 'experon-thinkup-style-shop', get_stylesheet_directory_uri() . '/style.css', array( 'thinkup-style' ), wp_get_theme()->get('Version') );
}
...
function experon_thinkup_updateoption_child_settings() {
	...
	$name_options_child   = $name_theme_lower . '_thinkup_child_settings_shop';
