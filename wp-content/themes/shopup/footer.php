...
?>
			...
			<div class="ascendoor-wrapper">
				<div class="site-footer-bottom-wrapper">
					<div class="site-info">
						<?php
						/**
						 * Hook: shopup_footer_copyright.
						 *
						 * @hooked - shopup_output_footer_copyright_content - 10
						 */
						do_action( 'shopup_footer_copyright' );
						?>
					</div><!-- .site-info -->
	...
	<?php
	$is_scroll_top_active = get_theme_mod( 'shopup_scroll_top', true );
