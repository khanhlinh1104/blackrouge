...
for ( $i = 1; $i <= $content_count; $i++ ) {
	...
	$content_ids[]         = $item_id;
	$btn_label[ $item_id ] = get_theme_mod( 'shopup_banner_button_label' . $i, __( 'Shop Now', 'shopup' ) );
...
function shopup_render_banner_section( $section_content, $btn_label, $btn_link ) {
	...
	?>
	<section id="shopup_banner_section" class="shopup-main-banner-section shopup-main-banner-slider-section">
		<?php
