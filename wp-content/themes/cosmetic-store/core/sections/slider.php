      ...
      while ( $arr_posts->have_posts() ) :
        ...
        <div class="blog_inner_box">
          ...
          <div class="blog_box pt-3 pt-md-0">
            ...
            <?php if ( get_theme_mod('cosmetic_store_title_unable_disable',true) ) : ?>
            <h3 class="my-3"><?php the_title(); ?></a></h3>
            <?php endif; ?>
            <?php if ( get_theme_mod('cosmetic_store_text_unable_disable',true) ) : ?>
            <p class="slider-text"><?php echo wp_trim_words( get_the_content(), get_theme_mod('cosmetic_store_post_excerpt_number',22) ); ?></p>
            <?php endif; ?>
            <?php if ( get_theme_mod('cosmetic_store_button_unable_disable',true) ) : ?>
            <p class="slider-button mt-4">
              <a href="<?php echo esc_url(get_permalink($post->ID)); ?>"><?php esc_html_e('Explore Our Products','cosmetic-store'); ?><i class="fas fa-long-arrow-alt-right ml-2"></i></a>
              <?php endif; ?>
            </p>
          </div>
        </div>
