...
class Feminine_Shop_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'feminine-shop' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $feminine_shop_font_awesome_icon_array = feminine_shop_font_awesome_icon_array();
                    foreach ($feminine_shop_font_awesome_icon_array as $feminine_shop_font_awesome_icon) {
                            $icon_class = $this->value() == $feminine_shop_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($feminine_shop_font_awesome_icon).'"></i>
                            <span class="feminine-shop-social-class">'.esc_attr($feminine_shop_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function feminine_shop_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'feminine-shop-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'feminine_shop_customizer_script' );

if(!function_exists('feminine_shop_font_awesome_icon_array')){
    function feminine_shop_font_awesome_icon_array(){
