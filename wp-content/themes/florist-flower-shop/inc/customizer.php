...
function florist_flower_shop_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control( new Florist_Flower_Shop_Toggle_Switch_Custom_Control( $wp_customize, 'florist_flower_shop_animation',array(
        'label' => esc_html__( 'Animations','florist-flower-shop' ),
	...
	$wp_customize->add_section( 'florist_flower_shop_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/flower-shop-wordpress-theme/">GO PRO</a>','florist-flower-shop'),
		'panel' => 'florist_flower_shop_panel_id'
	) );
	...
	$wp_customize->add_section('florist_flower_shop_product_slide_section',array(
		...
		'description' => __('For more options of product section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/flower-shop-wordpress-theme/">GO PRO</a>','florist-flower-shop'),
		'panel' => 'florist_flower_shop_panel_id',
	));
	...
	$wp_customize->add_section('florist_flower_shop_product_section',array(
		...
		'description' => __('For more options of bestselling product section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/flower-shop-wordpress-theme/">GO PRO</a>','florist-flower-shop'),
		'panel' => 'florist_flower_shop_panel_id',
	));
	...
	$wp_customize->add_section('florist_flower_shop_footer',array(
		...
		'description' => __('For more options of footer section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/flower-shop-wordpress-theme/">GO PRO</a>','florist-flower-shop'),
		'panel' => 'florist_flower_shop_panel_id',
	));	
	...
	*/
	public function sections( $manager ) {
		...
		$manager->add_section(new Florist_Flower_Shop_Customize_Section_Pro($manager,'florist_flower_shop_get_started_link',array(
			...
			'pro_url'  => esc_url('https://www.vwthemesdemo.com/docs/free-florist-flower-shop/'),
		)));
	}
